...
import (
	...
	"github.com/IgorFilipovich/op-geth/crypto/signify"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/IgorFilipovich/op-geth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/IgorFilipovich/op-geth/internal/version.gitDate="+env.Date)
	}
	if env.Tag != "" {
		ld = append(ld, "-X", "github.com/IgorFilipovich/op-geth/version.gitTag="+env.Tag)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/IgorFilipovich/op-geth/core/rawdb", "github.com/IgorFilipovich/op-geth/ethdb/leveldb"},
		{"github.com/IgorFilipovich/op-geth/core/rawdb", "github.com/IgorFilipovich/op-geth/ethdb/pebbledb"},
	}
